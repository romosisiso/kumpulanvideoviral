...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://kumpulanvideoviral.pages.dev/v/${file.filecode}`,
